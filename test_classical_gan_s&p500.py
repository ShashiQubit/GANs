# -*- coding: utf-8 -*-
"""Test-Classical_GAN_S&P500.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1NDVfI3_q7aDDbn4Azp4rL0JfgREW2oQI
...
#!pip install silence_tensorflow yfinance matplotlib numpy scipy statsmodels
...
# Show the plot
plt.savefig("plots/Direct_and_log_returns.svg", format="svg")
plt.close()
...
plt.savefig("plots/Normalization.svg", format="svg")
plt.close()
...
plt.savefig("plots/inverse Lambert W transform.svg", format="svg")
plt.close()
...
plt.savefig("plots/Check Reverse Process.svg", format="svg")
plt.close()
...
plt.savefig("plots/Lambert W Transform.svg", format="svg")
plt.close()
...
plt.ylabel('Sample Quantiles')
plt.grid(True)
plt.savefig("plots/Q-Q Plot - Reversed pre-processed S&P 500 Log Returns.svg", format="svg")
plt.close()
...
plt.savefig("plots/Original Log-Returns and Generated Log-Returns.svg", format="svg")
plt.close()
...
plt.savefig("plots/Original vs Generated Density and Theoretical Quantiles.svg", format="svg")
plt.close()
...
plt.savefig("plots/ACF Log-Returns and ACF Log-Returns (Generated).svg", format="svg")
plt.close()
...
axes[1].grid()
plt.savefig("plots/ACF Absolute Log-Returns and ACF Absolute Log-Returns (Generated).svg", format="svg")
plt.close()
...
axes[1].grid()
plt.savefig("plots/Original Leverage Effect and Generated Leverage Effect.svg", format="svg")
plt.close()
